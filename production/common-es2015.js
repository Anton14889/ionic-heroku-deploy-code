...
let CartService = class CartService {
    ...
    addToCart(userEmail, productName, objDescripton) {
    ...
    deleteFromCart(userEmail, productName) {
        this.firestore.collection(`usersData`)
            .doc(`${userEmail}`)
            .collection('cart')
            .doc(productName)
...
let FavoritesService = class FavoritesService {
    ...
    addToFavorites(userEmail, productName, objDescripton) {
        this.firestore.collection(`usersData`)
            .doc(`${userEmail}`)
    ...
    deleteFromFavorites(userEmail, productName) {
        this.firestore.collection(`usersData`)
            .doc(`${userEmail}`)
            .collection('favorites')
            .doc(productName)
