...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesCartServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartService = /*#__PURE__*/function () {
      function CartService(firestore) {
      ...
      _createClass(CartService, [{
        key: "addToCart",
        value: function addToCart(userEmail, productName, objDescripton) {
          this.firestore.collection("usersData").doc("".concat(userEmail)).collection('cart').doc(productName).set(objDescripton).then(function () {})["catch"](function (e) {
            console.warn(e);
        ...
        key: "deleteFromCart",
        value: function deleteFromCart(userEmail, productName) {
          this.firestore.collection("usersData").doc("".concat(userEmail)).collection('cart').doc(productName)["delete"]().then(function () {})["catch"](function (e) {
            console.warn(e);
            alert('ERROR DELETE');
          });
        }
    ...
    CartService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]])], CartService);
    /***/
  },
  ...
  function srcAppServicesFavoritesServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FavoritesService = /*#__PURE__*/function () {
      ...
      _createClass(FavoritesService, [{
        key: "addToFavorites",
        value: function addToFavorites(userEmail, productName, objDescripton) {
          this.firestore.collection("usersData").doc("".concat(userEmail)).collection('favorites').doc(productName).set(objDescripton).then(function () {})["catch"](function (e) {
            console.warn(e);
            alert('error add to cart');
          });
        }
        ...
        value: function deleteFromFavorites(userEmail, productName) {
          this.firestore.collection("usersData").doc("".concat(userEmail)).collection('favorites').doc(productName)["delete"]().then(function () {})["catch"](function (e) {
            console.warn(e);
            alert('ERROR DELETE');
          });
        }
    ...
    FavoritesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]])], FavoritesService);
    /***/
  }
}]);
