...
let AdminCardComponent = class AdminCardComponent {
    constructor() { }
    ngOnInit() { }
    setItem(item) {
...
], AdminCardComponent.prototype, "items", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
], AdminCardComponent.prototype, "token", void 0);
AdminCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-admin-card',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./admin-card.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/admin-card/admin-card.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./admin-card.component.scss */ "./src/app/admin/admin-card/admin-card.component.scss")).default]
    }),
...
/* harmony import */ var _admin_card_admin_card_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./admin-card/admin-card.component */ "./src/app/admin/admin-card/admin-card.component.ts");
/* harmony import */ var _card_details_card_details_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./card-details/card-details.module */ "./src/app/admin/card-details/card-details.module.ts");
...
AdminPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _card_details_card_details_module__WEBPACK_IMPORTED_MODULE_8__["CardDetailsModule"]
        ],
...
let AdminPage = class AdminPage {
    constructor(firestore, userData) {
    ...
    ngOnInit() {
        this.userData.subject
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(e => !!e), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(e => !!e['token']))
            .subscribe(e => this.token = e.token);
    }
};
...
AdminPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-admin',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./admin.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/admin.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./admin.page.scss */ "./src/app/admin/admin.page.scss")).default]
    }),
...
let CardDetailsComponent = class CardDetailsComponent {
    ...
    url(img) {
        return `https://firebasestorage.googleapis.com/v0/b/shopping-backend-firebas-8d9fe.appspot.com/o/images%2F${img}?alt=media&token=${this.token}`;
    }
};
CardDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-card-details',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./card-details.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/card-details/card-details.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./card-details.component.scss */ "./src/app/admin/card-details/card-details.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
...
/* harmony import */ var _card_details_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./card-details.component */ "./src/app/admin/card-details/card-details.component.ts");
...
let CardDetailsModule = class CardDetailsModule {
};
CardDetailsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{ path: 'tabs/admin/admin-details', component: _card_details_component__WEBPACK_IMPORTED_MODULE_6__["CardDetailsComponent"] }])
        ],
...
const routes = [
    ...
    {
        path: 'details',
        loadChildren: () => Promise.all(/*! import() | card-details-card-details-module */[__webpack_require__.e("common"), __webpack_require__.e("card-details-card-details-module")]).then(__webpack_require__.bind(null, /*! ./card-details/card-details.module */ "./src/app/card-details/card-details.module.ts")).then(m => m.CardDetailsPageModule)
    },
    {
        path: 'tabs/admin',
        canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]],
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./admin/admin.module */ "./src/app/admin/admin.module.ts")).then(m => m.AdminPageModule)
    },
    {
        path: 'tabs/sign',
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, afAuth, firestore, userData) {
    ...
    auf() {
        this.afAuth.auth.onAuthStateChanged((user) => {
            if (user) {
                // console.log(user)
                user.getIdTokenResult().then(e => localStorage.setItem('token', e.token));
                this.userData.userData(user.email);
                this.getCartSize(user);
                this.getFavoritSize(user);
                this.firestore.collection("admins").doc('eQbHkjgcwiGpCqwWHyzj').get().subscribe(data => {
                ...
                this.userData.userData('guest');
            }
        });
    }
    getCartSize(e) {
        this.firestore.collection('usersData')
            .doc(e.email)
            .collection('cart')
            .valueChanges()
            .subscribe(e => {
            let size = e.length ? e.length : null;
            this.userData.userCartSize(size);
        });
    }
    getFavoritSize(e) {
        this.firestore.collection('usersData')
            ...
            .valueChanges()
            .subscribe(e => {
            let size = e.length ? e.length : undefined;
            this.userData.userFavoritSize(size);
        });
    }
};
...
/* harmony import */ var _admin_card_details_card_details_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./admin/card-details/card-details.module */ "./src/app/admin/card-details/card-details.module.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"],
            ...
            _admin_admin_module__WEBPACK_IMPORTED_MODULE_15__["AdminPageModule"], _admin_card_details_card_details_module__WEBPACK_IMPORTED_MODULE_16__["CardDetailsModule"]
        ],
        providers: [
...
let AuthGuard = class AuthGuard {
    constructor(userData, router, ngZone) {
        this.userData = userData;
        this.router = router;
        this.ngZone = ngZone;
    }
    canActivate(next, state) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"](observer => {
            data = this.userData.subject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(e => e != null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(e => e['admin'] != null))
                .subscribe(e => {
                if (e['admin']) {
                    observer.next(true);
                }
...
AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_user_data_service__WEBPACK_IMPORTED_MODULE_3__["UserDataService"],
...
module.exports = __webpack_require__(/*! E:\ionic\shopping\src\main.ts */"./src/main.ts");
